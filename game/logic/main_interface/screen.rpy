...
screen add_book():
    ...
    viewport:
        ...
        viewport:
            ...
            ymaximum 300
            add '#0000'
            #text 'Ура, ты нашел книгу! Сдай в библиотеку и получи очки факультета' xalign .5 yalign .5
...
label mina_dale_hotel_1_label:
    ...
    #"Идея для интро анимации: Мина стоит за стойкой, на звук колокольчика от открытой двери она расплямляется, поворачивается и улыбается ГГ,

    # #ГГ здоровается и спрашивает про комнаты, Мина краснеет от одного его вида, но гоаорит что большинство комнат сейчас закрыты на ремонт, но есть самая простая с одинарной кроватью за скромную сумму. ГГ говоирт большое спасибо и может уйти или сразу пойти спать."
    # show sc i_Mina_anim_1 with my_dissolve
    # "[Name]" "(Кажется это местный отель.)"
    # show sc i_Mina_anim_1_z with my_dissolve
    # "[Name]" "(Интересно, у них есть скидки для студентов?)"
    # "[Name]" "(Ох, кажется спать тут будет довольно уютно.)"
    # "Unknown Girl" "Здравствуйте! Добро пожаловать в Дейли-ли Апартментс!"
    # show sc i_Mina_1_1 with my_dissolve
    # "Mina" "Меня зовут Мина. Как я могу к вам обращаться?"
    # "[Name]" "Приятно познакомится. Меня зовут [Name]."
    # "Mina" "[Name], вы ищите комнату на ночь?"
    # show sc i_Mina_1_2 with my_dissolve
    # "[Name]" "Вы случайно не волшебница?"
    # "Mina" "Нет, почему?"
    # "[Name]" "Просто вы так искуссно прочитали мои мысли!"
    # show sc i_Mina_1_3 with my_dissolve
    # "Mina" "Хи-хи."
    # "[Name]" "(Какая она милашка.)"
    # show sc i_Mina_1_2 with my_dissolve
    # "Mina" "Сейчас большинство наших комнат в ремонте."
    # "Mina" "Вечеринка магов после конференции елементалистов вышла из под контроля."
    # "[Name]" "Сожалею."
    # "Mina" "Случается. Особенности бизнеса в Дейле."
    # show sc i_Mina_1_4 with my_dissolve
    # "Mina" "Так что сейчас у нас доступны только простые комнаты с однокомнатной кроватью."
    # "[Name]" "Понятно. А какие у вас расценки?"
    # "Mina" "$5 за ночь."
    # "[Name]" "Понял. Спасибо."
    # show sc i_Mina_1_5 with my_dissolve
    # "Mina" "Я могу вам чем-то ещё помочь?"
    # menu:
    #     "Что вы читаете":
    #         show sc i_Mina_1_5 with my_dissolve
    #         "[Name]" "Вы так увлеченно читали, что мне самому захотелось."
    #         "[Name]" "Не подскажете, что за книга?"
    #         show sc i_Mina_1_6 with my_dissolve
    #         "Mina" "Ой, это...Да так, пустяки..."
    #         "[Name]" "(Чего это ты так покраснела?)"
    #         "[Name]" "(Я же всё равно вижу краем глаза название книги...)"
    #         "[Name]" "(Delta of Venus? Разве это не сборник порно-новелл?)"
    #         "[Name]" "(А ты не такая невинная, какой кажешься на первый взгляд.)"
    #         show sc i_Mina_1_7 with my_dissolve
    #         "[Name]" "Жаль. Как раз искал что почитать наночь, чтобы лучше спалось."
    #         "Mina" "..."
    #         "Mina" "Извините, ничего не приходит интересного на ум."
    #     "Скидки студентам":
    #         show sc i_Mina_1_5 with my_dissolve
    #         "[Name]" "Хотел узнать есть ли у вас скидки для студентов академии."
    #         show sc i_Mina_1_8 with my_dissolve
    #         "Mina" "О, так вы студент?"
    #         "Mina" "А так и не скажешь, я думала вы искатель приключений..."
    #         "[Name]" "(Хм? С чего бы это?)"
    #         show sc i_Mina_1_2 with my_dissolve
    #         "[Name]" "Одно другому не мешает."
    #         "Mina" "Конечно."
    #         "Mina" "На самом деле у нас с академией многолетняя договорённость."
    #         "Mina" "Первокурсники могут оставаться в простых комнатах бесплатно."
    #         "[Name]" "Оу, радостно слышать!"
    #         show sc i_Mina_1_2 with my_dissolve
    #         "Mina" "Я могу вам чем-то ещё помочь?"
    #         "[Name]" "Наверное нет. "
    #         "[Name]" "Спасибо, Мина."
...
#     stop music_2 fadeout 1
#     play music 'audio_ep2/SC/8. Beautiful people.mp3' fadein 1.0
#     "#Нет изображений для этой сцены"
#     show sc i_dale_street_2_3  with my_dissolve
# #     "Охранник говорин что ГГ не соответствует его стандартам, но он готов закрыть глаза гна это за 50 баксов (цену укажет Ярослав). ГГ или плати и проходит, тогда в следующий раз такая же сцена. 

# # Или отказыватся и тогда запускается доп. сцена: ГГ отходит от охранника и видит как мужик протягивает охраннику конверт. Тот туда заглядывает и немного в шоке. Мужик говорит Охраннику: Ты сегодня весь вечер ничего не слышишь. 

# # ГГ может что-то заподозрить и проскользнуть за челом в подворотню. Там нужно прождать в укрытии и увидеть как он пытается изнасиловать Адель, которая вышла покурить. ГГ может защитить её и в благодарность получить випку. Потом Адель его встречает внутри, нужно сделать два интро на случай если он сделал квест не будучи в клубе.

# # Или можно посмотреть как её насилуют и подобрать потом выпавшую из кармана чела вип карту."
#     show sc i_Romul_1_1 with my_dissolve
#     "Romul" "Куда спешим, молодой человек?"
#     "[Name]" "Просто изучаю окресности. "
#     "[Name]" "Дай думаю в клуб заглянуть."
#     show sc i_Romul_1_2 with my_dissolve
#     "Romul" "Гулай по свежему воздуху дальше, сошка."
#     "Romul" "Ты не проходишь."
#     "[Name]" "Это почему это?!"
#     show sc i_Romul_1_3 with my_dissolve
#     "Romul" "Ты не соответствуешь стандартам."
#     "[Name]" "Каким стандартам?!"
#     "Romul" "Моим личным стандартам."
#     "Romul" "Рожа твоя мне не нравится."
#     show sc i_Romul_1_4 with my_dissolve
#     "[Name]" "(Какого черта?!)"
#     "[Name]" "(Нужно держать себя в руках.)"
#     "[Name]" "(Вряд ли кто-то в академии одобрит изибиение охранника клуба.)"
#     show sc i_Romul_1_5 with my_dissolve
#     "Romul" "Хм... Может быть я погорячился?"
#     "Romul" "Может быть ты не обсос и тебя стоит пустит в клуб?"
#     "[Name]" "(Я понял, к чему он клонит...)"
#     show sc i_Romul_1_6 with my_dissolve
#     "Romul" "Никак не могу решить..."
#     "Romul" "С одной стороны, ты не проходишь мои стандарты."
#     show sc i_Romul_1_7 with my_dissolve
#     "Romul" "С другой,  я верю в капитализм и вторые шансы!"
#     show sc i_Romul_1_19 with my_dissolve
#     "Romul" "Может быть что-то может помочь чаще весов перевесить?"
#     "[Name]" "Сколько? "
#     "Romul" "$50"
#     "[Name]" "(Нихуя себе... А цену он сразу назвал, без лирики.)"
...
#     "[Name]" "Чёрт с тобой, Нимезида."
#     "Romul" "Чего?"
#     "[Name]" "Не вникай, тебе вредно."
#     "[Name]" "Я могу пройти?"
...
#     "Romul" "Я передумал."
#     "[Name]" "Какого черта, чувак?"
#     "Romul" "Я сегодня не в настроении слушать подколы каких-то сопляков."
#     "[Name]" "Я тебе заплатил!"
#     show sc i_Romul_1_21 with my_dissolve
#     "Romul" "За совет!"
#     "Romul" "Хочешь попасть внутрь? Веди себя вежливо, плати молча и улыбаясь."
#     "Romul" "И ради Мерлина, оденься поприличнее!"
#     "Romul" "Всё, вали."
#     show sc i_Romul_1_22 with my_dissolve
#     "Romul" "Или хочешь решить это по другому?!"
# label romul_dale_clubenter_label_42:
#     show sc i_Romul_1_10 with my_dissolve
#     "[Name]" "Это того не стоит."
#     "[Name]" "Чао."
#     "Romul" "Вали отсюда, обсос."
#     show sc i_Romul_1_11 with my_dissolve
#     "[Name]" "(Как же хочется опробовать combta bolt на нём...)"
#     "[Name]" "(Черт, кажется клуба мне сегодня не видать.)"
#     show sc i_Romul_1_12 with my_dissolve
#     "[Name]" "(Хм, какой странный чел.)"
#     "[Name]" "(Интересно, что ему скажет бугай на входе.)"
#     "[Name]" "(Не могу сдержать любопытство..)"
#     "[Name]" "(Нужно подслушать!)"
#     show sc i_Romul_1_13 with my_dissolve
#     "Romul" "Извини, чувак, твоя VIP тут не поможет."
#     "Romul" "Девочки жаловались, так что тебе вход закрыт навсегда."
#     show sc i_Romul_1_14 with my_dissolve
#     "Man" "Мне и не нужно внутрь. Держи ка.."
#     show sc i_Romul_1_15 with my_dissolve
#     "Romul" "Ого! Тут...Тут же..."
#     "Man" "Т-с-с! Это всё твоё."
#     show sc i_Romul_1_16 with my_dissolve
#     "Man" "Просто сделай вид сегодня, что ничего не слышишь."
#     show sc i_Romul_1_17 with my_dissolve
#     "[Name]" "(Что-то тут не ладное.)"
#     "[Name]" "(Как этот дебил мог согласиться на такое?)"
#     "[Name]" "(Погодите-ка, тот мужик даже не собирался в клуб...)"
#     show sc i_Romul_1_18 with my_dissolve
#     "[Name]" "(Это очень странно... Я должен за ним проследить.)"
#     show sc i_Romul_1_18 with my_dissolve
#     "[Name]" "(Вечно я ввязываюсь во всякие передряги...)"
#     "[Name]" "(Но не могу же просто так это оставить?)"
